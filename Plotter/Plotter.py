...
'''
Necessary imports required for project
Note: Cufflinks and plotly used offline
'''
import numpy as np
import pandas as pd
...
#Setting plotly and cufflinks to offline mode
...
'''
Creating different types of data as mentioned by user

@params The data contains numbers to choose between three types i.e random numbers, customized dataframe and csv/json file
'''
def createdata(data):
    if data==1:
...
'''
To plot complete data of the dataframe.

@params The plot varies from 1 to 6 each number having a different type of plot
'''
def plotter(plot):
    if plot==1:
...
'''
To plot column wise data

@params The plot varies from 1 to 7 wherein each number has a different plot
'''
def plotter2(plot):
...
'''
Depending upon the category selected it either goes to plotter function or plotter2 function for plotting

@params Category is of two types i.e complete data and specific column wise data
'''
def main(cat):
    if cat==1:
        print('1.Line plot')
